...
public:
    ...
    public:
        // Define iterator traits manually
        using iterator_category = std::bidirectional_iterator_tag;
        using value_type        = std::pair<Number, LabelType>;
        using difference_type   = std::ptrdiff_t;
        using pointer           = std::pair<Number, LabelType>*;
        using reference         = std::pair<Number, LabelType>&;
